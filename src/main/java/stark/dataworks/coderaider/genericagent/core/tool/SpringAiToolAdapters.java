...
/**
 * SpringAiToolAdapters provides high-level compatibility bridges from Spring AI tool APIs to generic-agent tools.
 */
public final class SpringAiToolAdapters
{
    ...
    /**
     * Adapts tool objects that use Spring AI {@code @Tool} annotations into generic-agent {@link ITool}s.
     *
    ...
    /**
     * Adapts Spring AI {@link ToolCallback} instances into generic-agent {@link ITool}s.
     *
